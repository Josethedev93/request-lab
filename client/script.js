...
// CODE HERE
function helloButtonDark() {
  sayHelloButton.style.backgroundColor = "black";
  sayHelloButton.style.color = "white";
}

sayHelloButton.addEventListener("mouseover", helloButtonDark);
// PROBLEM 3
/*
...
// CODE HERE
function helloButtonLight() {
  sayHelloButton.style.backgroundColor = "#EFEFEF";
  sayHelloButton.style.color = "black";
}

sayHelloButton.addEventListener("mouseout", helloButtonLight);
...
function repeatMyParam()  {
  //YOUR CODE HERE
return axios.get('http://localhost:3000/repeat/{"pizza"}')
  .then((res) => {
...
function getQuery() {
  axios
    .get("http://localhost:3000/repeat?myquery=i-love-pizza&myLove=Pizza")
